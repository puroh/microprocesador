...
void obtenerBandera(bool *bands) //Funcion que se crea para obtener el valor de las banderas en otros archivos incroporados al proyecto
{
    bands=banderas; //Manda al archivo salto la modificacio|n de las banderas 
}
void SalvarBanderas(bool *bands) //Funcion que almacena los valores de las banderas en otros archivos incroporados al proyecto
{
    banderas[C]=bands[C]; //Igualacion de banderas con bands que se genera en otros archivos para guaradar el valor de la bandera de carry
    banderas[Z]=bands[Z]; //Igualacion de banderas con bands que se genera en otros archivos para guaradar el valor de la bandera de zero
    banderas[N]=bands[N]; //Igualacion de banderas con bands que se genera en otros archivos para guaradar el valor de la bandera de negativo
    banderas[V]=bands[V]; //Igualacion de banderas con bands que se genera en otros archivos para guaradar el valor del bandera de sobreflujo
}
